...
# [Revenue] Olist 셀러 AARRR 퍼널 분석 — 채널·리드 특성별 LTV 비교

---

## 분석 목표

> **"각 채널(Paid Search, Organic, Social 등)로 모집한 셀러 중, 누가 플랫폼에 가장 높은 장기 매출(LTV)을 만들었는가? 채널별 셀러 가치를 비교해 마케팅 투자 우선순위를 도출할 수 있는가?"**

※ 마케팅 비용 데이터가 없어 실제 ROI(= LTV/CAC) 산출은 불가. 셀러 가치(LTV) 기준으로 투자 우선순위를 도출합니다.
...
| 채널 | MQL | Won | Active | 총 GMV (R$) | MQL당매출 (R$) | 셀러당 LTV (R$) | A등급 | A등급 비율 |
|:---|:---:|:---:|:---:|---:|---:|---:|:---:|:---:|
| unknown | 1,159 | 193 | 85 | 214,985 | 185 | **2,529** | 20 | 23.5% |
| organic_search | 2,296 | 271 | 113 | 207,023 | 90 | **1,832** | 32 | **28.3%** |
| referral | 284 | 24 | 9 | 17,887 | 63 | **1,987** | 5 | **55.6%** |
| paid_search | 1,586 | 195 | 101 | 155,277 | 98 | 1,537 | 25 | 24.8% |
| social | 1,350 | 75 | 31 | 43,478 | 32 | 1,403 | 7 | 22.6% |
| email | 493 | 15 | 6 | 8,485 | 17 | 1,414 | 1 | 16.7% |
| direct_traffic | 499 | 56 | 31 | 21,904 | 44 | 707 | 4 | 12.9% |
| display | 118 | 6 | 2 | 924 | 8 | 462 | 0 | 0% |

**핵심 발견:**
- unknown이 셀러당 LTV R$2,529로 1위이나, 채널 추적이 불가하여 전략 근거로 사용할 수 없음
- 추적 가능 채널 중 referral(R$1,987)이 LTV 1위, organic_search(R$1,832)가 2위
- referral은 9명뿐이지만 A등급 비율 55.6%로 압도적 — "적게 오지만 살아남으면 가장 많이 파는" 채널

### 1-2. Acquisition 순위와의 비교 — "Acq 1위 ≠ Rev 1위"

| 채널 | MQL당매출 순위 (Acq) | 셀러당 LTV 순위 (Rev) | 변화 |
|:---|:---:|:---:|:---|
| paid_search | 1위 (R$98) | 3위 (R$1,537) | **하락** — 많이 들어오지만 오래 팔지 않음 |
| organic_search | 2위 (R$90) | 2위 (R$1,832) | 유지 — 모든 단계 안정 |
| referral | 하위 (R$63) | 1위 (R$1,987) | **역전** — 숨은 강자. A등급 55.6% |
| social | 최하위 (R$32) | Median 1위 (R$722) | **역전** — 살아남은 소수가 꾸준히 팜 |
| direct_traffic | 중위 (R$44) | 최하위 (R$707) | **급락** — 살아남기는 잘하지만 많이 팔지 못함 |

> **시사점:** Acquisition의 MQL당 매출만으로 예산을 배분하면 referral과 social의 장기 가치를 놓칩니다. Revenue의 셀러당 LTV와 A등급 비율을 함께 봐야 합니다.

---

## 2. 리드 프로파일별 LTV 비교 (킬 차트 ② — unknown 보완)

### 2-1. 프로파일별 Mean vs Median LTV

| 프로파일 | 활성 셀러 | Mean LTV (R$) | Median LTV (R$) | Mean/Median | Max (R$) | A등급 | A등급 비율 |
|:---|:---:|---:|---:|:---:|---:|:---:|:---:|
| 🦈 상어 (대형/전문) | 10 | **4,951** | 801 | 6.2배 | 36,537 | 5 | **50%** |
| 🦅 독수리 (집중/성장) | 51 | 1,796 | 749 | 2.4배 | 12,251 | 16 | 31% |
| 🐱 고양이 (소형/입문) | 186 | 1,524 | 518 | 2.9배 | 44,212 | 43 | 23% |
| 🐺 늑대 (공격적/대량) | 44 | **487** | **213** | 2.3배 | 2,369 | 3 | **7%** |

### 2-2. 늑대는 왜 고양이보다 낮은가? — "데이터 오류가 아닌 구조적 문제"

**결론: 데이터 오류가 아닙니다.** 늑대는 "공격적 가격·대량 판매" 전략을 추구하지만, Olist 플랫폼에서는 이 전략이 작동하지 않습니다.

- Median R$213 (고양이 R$518의 41%) — 중앙값 기준으로도 절반 이하
- Max R$2,369로 천장 자체가 낮음 (고양이 Max R$44,212의 1/19)
- 주문 중앙값 3건 — "많이 팔기"도 실패
- A등급 3명(7%) — 고양이(23%)의 1/3
- 늑대의 박리다매 전략은 Olist 같은 마켓플레이스에서 주문량이 따라오지 못해 LTV가 구조적으로 낮음

### 2-3. 사업 유형별 LTV — Retention → Revenue 확장

| 사업 유형 | Won | Active | 활성률 | 평균 LTV (R$) | Median LTV (R$) |
|:---|:---:|:---:|:---:|---:|---:|
| Reseller | 587 | 287 | 48.9% | **2,084** | 587 |
| Manufacturer | 242 | 90 | 37.2% | 860 | 410 |

- Retention에서 활성률 차이(11.7%p)였던 것이 Revenue에서 LTV 차이 **2.4배**로 증폭됨
- Reseller는 "살아남기도 잘하고, 살아남은 후에도 더 많이 파는" 유형

---

## 3. 채널 × 프로파일 교차 분석 — 황금 조합 발견

### 3-1. 상위 조합 TOP 5

| 순위 | 채널 | 프로파일 | 셀러 수 | 셀러당 LTV (R$) |
|:---:|:---|:---|:---:|---:|
| 1 | paid_search | 상어 (대형/전문) | 3 | **14,200** |
| 2 | unknown | 미분류 | 22 | 6,742 |
| 3 | other | 독수리 (집중/성장) | 1 | 5,803 |
| 4 | organic_search | 고양이 (소형/입문) | 56 | 2,554 |
| 5 | referral | 미분류 | 2 | 2,459 |

**핵심 발견:**
- paid_search × 상어 = R$14,200(3명)으로 전체 최고 — 단, 3명이라 소수
- unknown × 미분류 = R$6,742(22명) — 채널도 모르고 프로파일도 모르지만 가장 큰 숨은 가치
- organic × 고양이 = R$2,554(56명) — 볼륨과 LTV 모두 안정적인 "실질 최적 조합"

---

## 4. Unknown 채널 검증 — Acquisition LP 분석과의 교차

### Acquisition 팀 추론: "unknown은 UTM 누락된 검색 트래픽"

| 비교 항목 | unknown (85명) | paid_search (101명) | 유사도 |
|:---|:---|:---|:---|
| 평균 LTV | R$2,529 | R$1,537 | unknown 1.6배 높음 |
| Median LTV | R$512 | R$512 | **동일** |
| 프로파일 1위 | cat (47%) | cat (47%) | **동일** |
| 리드타입 1위 | online_medium | online_medium | **유사** |

**Revenue 검증 결과:** Median LTV가 R$512로 완전 동일하고 프로파일 분포도 거의 같음. Mean이 높은 이유는 상위 2명(R$10K+)의 극단값 영향. **Median으로 보면 두 채널은 사실상 동일 모집단** — Acquisition의 추론을 Revenue 데이터가 뒷받침.

---

## 5. Retention → Revenue 연결: "첫 판매 14일 = LTV 11배 차이"

### 첫 판매까지 소요일별 LTV

| 첫 판매 소요일 | 활성 셀러 | 평균 LTV (R$) | Median LTV (R$) | 평균 주문 |
|:---|:---:|---:|---:|:---:|
| ~14일 | 25 | **7,845** | 1,469 | 46.6건 |
| 15~28일 | 73 | 2,397 | 1,109 | 15.6건 |
| 29~45일 | 75 | 1,835 | 722 | 15.6건 |
| 46~60일 | 52 | 900 | 422 | 7.3건 |
| 61~90일 | 87 | 853 | 399 | 5.2건 |
| 91일+ | 68 | 693 | 241 | 3.1건 |

**핵심 발견:**
- 14일 이내 첫 판매 셀러 LTV R$7,845 vs 91일+ R$693 = **11.3배 차이**
- Median으로도 R$1,469 vs R$241 = **6.1배 차이**
- Retention의 "28일 골든타임"을 Revenue로 확장: 28일 이내(98명) 평균 LTV R$3,859 vs 28일 초과(282명) R$887 = **4.4배 차이**
- "빠른 전환이 좋은 셀러를 만든다"(Acquisition) → "빠른 첫 판매가 생존을 결정"(Retention) → "빠른 첫 판매가 LTV를 11배 높인다"(Revenue) — AARRR 관통 스토리 완성

---

## 6. 투자 우선순위 매트릭스 — AARRR 전체 관통

### AARRR 통합 채널 판정

| 채널 | CVR (Acq) | 활성률 (Ret) | 셀러당 LTV (Rev) | A등급 비율 | 통합 판정 |
|:---|:---:|:---:|---:|:---:|:---|
| **organic_search** | 11.8% | 41.7% | R$1,832 | 28.3% | ★ 균형 최적 — 모든 단계 안정 |
| **paid_search** | 12.3% | 51.8% | R$1,537 | 24.8% | ★ 볼륨 최적 — 활성률 높고 규모 큼 |
| referral | 8.5% | 37.5% | R$1,987 | **55.6%** | ◎ 숨은 강자 — A등급 비율 압도적 |
| social | 5.6% | 41.3% | R$1,403 | 22.6% | △ 전환율 개선 필요 |
| direct_traffic | 11.2% | **55.4%** | R$707 | 12.9% | △ 활성률만 높고 LTV 낮음 |
| unknown | 16.7% | 44.0% | R$2,529 | 23.5% | — 추적 개선 후 재판단 |
...
| # | 시기 | 액션 | 근거 | 기대 효과 |
|:---:|:---|:---|:---|:---|
| 1 | 즉시 | **unknown UTM 추적 정비** | unknown에 R$214,985(31.8%) 매출이 숨어 있으나 추적 불가 | unknown 35%→15%. 채널 투자 판단 정밀도 2배 |
| 2 | 즉시 | **상어+Reseller 리드 SDR 즉시 배정** | 상어 LTV 2.8배, Reseller LTV 2.4배 | A등급 셀러 확보 확률 극대화 |
| 3 | 단기 | **organic + paid 이중 투자** | organic A등급 28.3%, paid 활성률 51.8% | 고가치 MQL 유입 증가 |
| 4 | 단기 | **referral 추천 프로그램 신설** | 9명이지만 A등급 55.6%. 볼륨 확대 필요 | 고LTV 셀러 유입 경로 확보 |
| 5 | 중기 | **첫 판매 14일 달성 프로그램** | 14일 이내 첫 판매 = LTV 11.3배 차이 | 가장 ROI 높은 온보딩 개입 |
| 6 | 중기 | **ML 리드 스코어링 도입** | 프로파일·세그먼트·전환속도로 LTV 예측 | 영업 리소스 효율 극대화 |
...
| 한계 | 영향 | 대응 |
|:---|:---|:---|
| 마케팅 비용(CAC) 부재 | 실제 ROI 산출 불가 | LTV 기준 가치 비교로 대체 |
| unknown 35% | 채널 분석 불완전 | 리드 특성(프로파일·세그먼트)으로 보완 + UTM 정비 제안 |
| 데이터 기간 (2016~2018) | 최신 트렌드 반영 어려움 | 분석 방법론의 범용성에 초점 |
| 소수 그룹 편차 | 상어 10명, referral 9명 등 소수 기반 분석 | Mean/Median 분리 제시. 소수임을 투명하게 보고 |

---

**Analyst: Revenue Part | Olist AARRR Funnel Analysis | 2026.04**